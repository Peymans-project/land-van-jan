...
- The homepage uses the sunny real `boomgaard-picknick` photo as a full-width desktop hero with a calm dark-green readability layer. Retain the original `land-hero` photograph in the timeline so no owner photograph disappears from the project; do not render generated artwork in the public experience.
