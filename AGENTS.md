...
- The homepage is an editorial split hero: calm dark-green title field beside the sunny real `boomgaard-picknick` photo. Keep that photo capped at 820px on desktop so it stays crisp rather than being enlarged across a wide monitor. Retain the original `land-hero` photograph in the timeline so no owner photograph disappears from the project; do not render generated artwork in the public experience.
